...
class _AdminPanel_ScreenState extends State<AdminPanel_Screen> {
  ...
  var WorkoutLevelController = TextEditingController();
  var SelectCategoryController = TextEditingController();
  var WorkoutPlanController = TextEditingController();
              ...
              children: [
                ...
                TextFormField(
                  decoration: InputDecoration(
                      labelText: 'Item name',
                      labelStyle:
                          TextStyle(fontFamily: 'JacquesFracois', fontSize: 12),
