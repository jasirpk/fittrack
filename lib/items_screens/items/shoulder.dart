...
import 'package:fittrack/items_screens/items/default_items/shoulder.dart';
import 'package:flutter/material.dart';
import 'package:hive_flutter/hive_flutter.dart';

class ShoulderItem_Screen extends StatefulWidget {
  final String selectedCategory;

  const ShoulderItem_Screen({super.key, required this.selectedCategory});

  @override
  State<ShoulderItem_Screen> createState() => _ShoulderItem_ScreenState();
}

class _ShoulderItem_ScreenState extends State<ShoulderItem_Screen> {
  @override
