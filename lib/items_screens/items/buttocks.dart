...
import 'package:fittrack/items_screens/items/default_items/butocks.dart';
import 'package:flutter/material.dart';
import 'package:hive_flutter/hive_flutter.dart';

class ButtocksItem_Screen extends StatefulWidget {
  final String selectedCategory;

  const ButtocksItem_Screen({super.key, required this.selectedCategory});

  @override
  State<ButtocksItem_Screen> createState() => _ButtocksItem_ScreenState();
}

class _ButtocksItem_ScreenState extends State<ButtocksItem_Screen> {
  @override
