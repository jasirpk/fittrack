...
import 'package:fittrack/items_screens/items/default_items/triceps.dart';
import 'package:flutter/material.dart';
import 'package:hive_flutter/hive_flutter.dart';

class TricepsItem_Screen extends StatefulWidget {
  final String selectedCategory;

  const TricepsItem_Screen({super.key, required this.selectedCategory});

  @override
  State<TricepsItem_Screen> createState() => _TricepsItem_ScreenState();
}

class _TricepsItem_ScreenState extends State<TricepsItem_Screen> {
  @override
