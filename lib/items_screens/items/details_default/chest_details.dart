...
class Chest_Details_Default extends StatefulWidget {
  const Chest_Details_Default({super.key});

  @override
  State<Chest_Details_Default> createState() => _Chest_Details_DefaultState();
}

class _Chest_Details_DefaultState extends State<Chest_Details_Default> {
  @override
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage('assets/images/8.gif'),
                        fit: BoxFit.contain)),
              ),
              SizedBox(
                height: 20,
