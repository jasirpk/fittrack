...
import 'package:fittrack/items_screens/items/default_items/legs.dart';
import 'package:flutter/material.dart';
import 'package:hive_flutter/hive_flutter.dart';

class LegsItem_Screen extends StatefulWidget {
  final String selectedCategory;

  const LegsItem_Screen({super.key, required this.selectedCategory});

  @override
  State<LegsItem_Screen> createState() => _LegsItem_ScreenState();
}

class _LegsItem_ScreenState extends State<LegsItem_Screen> {
  @override
